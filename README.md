...
> ⚠️ 目前文字只按 `lineSpacing` 等距排布，**不会**对齐照片上原有的作业本横线。
> 「横线导引」的**引擎**已在 v2.8.0 落地（文字逐字沿手绘曲线排布，跟随纸张弯曲），
> 但编辑 UI 尚未完成 —— 目前通过预设文件的 `line_guide_*` 配置项使用，
> 见 [`docs/PLAN_LINE_GUIDES_2026-09-13.md`](docs/PLAN_LINE_GUIDES_2026-09-13.md)。
